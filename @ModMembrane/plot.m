...
%--------------------------------------------------------------------------
        % plot performs the visulization of @ModMembrane
        % input: 
...
ip.addParameter('LineCol', [0.1490    0.1490    0.1490], @isnumeric);
ip.addParameter('light_ang',[0 30]);
ip.addParameter('LineWidth', 0.5, @isnumeric);
ip.addParameter('viewAng', [10 30], @isnumeric);
