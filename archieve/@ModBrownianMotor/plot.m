...
%--------------------------------------------------------------------------
        % plot performs the visulization of @ModBrownianMotor
        % input: 
...
scatter3(obj.var.coord(:,1),obj.var.coord(:,2),obj.var.coord(:,3),ScatterSize,'h','filled','MarkerFaceColor',Color,'MarkerFaceAlpha',FaceAlpha);
