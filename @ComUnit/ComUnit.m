...
%==========================================================================
%--------------------------------------------------------------------------
        % ComUnit stores the data of unit and contains the functions for
        % setting natural unit system defined by users
        %   See also model
...
%==========================================================================    
    properties
        typ %unit system, currently only 'erg' is supported
        unit 
        unit_nat %natural unit of regular dimensions, e.g. energy, length
        unit_nat_any %natural unit of any dimensions, e.g. energy^2/length^3
    end
%==========================================================================    
    methods
%==========================================================================
