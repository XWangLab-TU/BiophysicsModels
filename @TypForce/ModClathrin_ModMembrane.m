function [f,V_tot] = ModClathrin_ModMembrane(f,mod,int_name,varargin)
...
dr=0.000001;
if mex_avail==false
[V] = mod.TypForce.ModClathrin_ModMembrane8V(mod,int_name,f.int_comp.(int_name){3});
...
%%
    [f_c,f_m,V_tot]=mex.ModClathrin_ModMembrane...
