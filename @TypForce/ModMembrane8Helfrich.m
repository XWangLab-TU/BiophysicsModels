function [m] = ModMembrane8Helfrich(f,m, varargin)
%--------------------------------------------------------------------------
        % ModMembrane8Helfrich performs the computation of Helfrich energy
        % of @ModeMembrane for computing bending force
        % input: 
        % f - @TypForce
...
m.var.f.H = sum(0.5*(2*m.var.f.kH).^2.*m.var.f.A);
%----------------------------------------------------------------------------------------
end
%========================================================================================
%========================================================================================
