function [] = memoryTest(dirRoot,dirMod,varargin)
%--------------------------------------------------------------------------
        % exampleFilopodia performs the example of forming filopodia
        % input: 
...
ip.addParameter('N', 12, @isnumeric); %number controlling vertex number
