function [vnew, fnew, meanedge, stdev]=remesh_remesher(V, F, edgelength, iterations)
% INPUT
...
%clean up patch
[vnew, fnew]=ComExternal.remesh_cleanpatch(V, F);
voriginal=vnew;
foriginal=fnew;
[vnew,fnew] = ComExternal.remesh_subdividelarge( vnew, fnew,edgelength,voriginal,foriginal );
voriginal=vnew;
foriginal=fnew;

for i=1:iterations
    
[vnew, fnew,temp] = ComExternal.remesh_edgecollaps( vnew, fnew, edgelength ,voriginal,foriginal);
[vnew, fnew, temp] = ComExternal.remesh_removebadtriangles( vnew, fnew,voriginal,foriginal);
[vnew,fnew] = ComExternal.remesh_subdividelarge( vnew, fnew,0 ,voriginal,foriginal);
[vnew, fnew, temp] = ComExternal.remesh_removebadtriangles( vnew, fnew,voriginal,foriginal);
