function [vnew, fnew, temp] = remesh_removebadtriangles( vnew, fnew ,voriginal,foriginal)
cases=vnew;
fk1 = fnew(:,1);
fk2 = fnew(:,2);
fk3 = fnew(:,3);
...
[vnew, fnew]=ComExternal.remesh_cleanpatch(vnew, fnew);
[vnew]=ComExternal.remesh_project(vnew, fnew,voriginal,foriginal);
end